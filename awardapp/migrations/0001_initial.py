# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2019-11-25 08:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post_rated', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='ratings', to='awardapp.Post')),
            ],
        ),
        migrations.AddField(
            model_name='post',
